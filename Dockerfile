...
## CORASON
RUN cachebuster=352 git clone https://github.com/nselem/orthocore
RUN mkdir /opt/CORE

 ######### PATHS ENVIRONMENT
ENV PATH /opt/blast/bin:$PATH:/opt/muscle:/opt/Gblocks:/opt/quicktree/quicktree_1.1/bin:/root/orthocore/CORE
